namespace Brewery.Contract.Contracts.Responses.Orders;
...
public class EstimateOrderResponse
{
    ...
    /// </summary>
    public IList<EstimateOrderItemResponse> Beers { get; set; }
...
public record EstimateOrderItemResponse(string Name, Guid? Id, int Count, double Price)
{
    /// <summary>
    /// Total
    /// </summary>
