...
namespace Brewery.DAL.Repositories.Users;
    ...
    /// </summary>
    [Injectable()]
    public class UserRepository : BaseRepository<BreweryContext, UserEntity>
    {
        ...
        public UserRepository(BreweryContext context) : base(context)
        {
            _context = context;
        }
